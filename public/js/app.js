...
require.register("jquery-match-height/dist/jquery.matchHeight.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "jquery-match-height");
  (function() {
    /**
...
require.register("js/jqBootstrapValidation.js", function(exports, require, module) {
"use strict";
...
require.register("js/jquery.browser.js", function(exports, require, module) {
'use strict';
...
require.register("js/miso.js", function(exports, require, module) {
'use strict';
    ...
    $(document).on('updateLivingdocsDesign', function (e, design) {
        ...
        for (var i in design.components) {
            if (design.components[i].name === 'teaser') {
                design.components[i].html = '<div class="teaser">' + '<a doc-link="link">' + '<div class="image-holder">' + '<img doc-image="image">' + '</div>' + '<h3 class="service-heading" doc-editable="label">Label</h3></a>' + '<p class="text-muted" doc-editable="description">Description</p>' + '</div>';
